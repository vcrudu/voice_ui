...
/* double */ town
    ...
    getTownScore(postcode, token, callback){
            debugger;
        $.ajax({
                url: APP_SETTINGS.serverApiUrl + "townscore?postcode="+postcode+"&token="+token,
                type: "GET",
                crossDomain: true,
                dataType: "json",
                contentType: "application/json; charset=utf-8"
            }).done((data)=> {
                if(callback) callback(null, data.score);
            }).fail((error)=> {
...
const qriskService = new QriskService();

export default qriskService;