...
(function () {
    ...
    var ValidationInput = React.createClass({
        ...
        render: function () {
            return React.createElement(
                ...
                React.createElement(
                    "label",
                    { className: "mdl-button mdl-js-button mdl-button--icon", htmlFor: this.props.inputName },
                    React.createElement(
                        "i",
                ...
                React.createElement(
                    "label",
                    { className: "mdl-textfield__label", htmlFor: this.props.inputName },
    ...
    var PatientSignUp = React.createClass({
        ...
        handleSubmit: function (event) {
            ...
            var canSubmit = this.state.email.isValid && this.state.password.isValid && this.state.confirmPassword.isValid && this.state.surname.isValid && this.state.givenName.isValid && this.state.phoneNumber.isValid;
        ...
        render: function () {
            return React.createElement(
                "form",
                { name: "signUpForm", onSubmit: this.handleSubmit, className: "mdl-cell mdl-cell--12-col", novalidate: true },
                ...
                React.createElement(
                    ...
                    React.createElement(
                        "button",
                        { type: "submit", href: "javascript:void(0);", className: "mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" },
                        "Register"
                    )
                )
            );
